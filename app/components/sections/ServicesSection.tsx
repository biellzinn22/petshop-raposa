...
const services = [
  {
    ...
    description: "Banho premium com shampoos hipoalergênicos e hidratação profunda.",
  ...
  },
  {
    ...
    description: "Tosa higiênica e estilizada respeitando a raça e personalidade.",
  ...
  },
  {
    ...
    description: "Consultas, vacinação, exames e orientação especializada.",
  ...
  },
  {
    icon: Heart,
    title: "Spa & Relax",
    description: "Aromaterapia, massagem e cuidados dermatológicos especiais.",
  ...
  },
  {
    ...
    description: "Rações premium, petiscos naturais, brinquedos e acessórios.",
